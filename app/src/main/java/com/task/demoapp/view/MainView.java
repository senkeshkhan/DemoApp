...
public class MainView extends FrameLayout {
  ...
  private void initialize(){
    ...
    mSplashView.setIconColor(Color.WHITE); // this is the Twitter blue color
    mSplashView.setIconResource(R.mipmap.folderorange); // a Twitter icon with transparent hole in it
